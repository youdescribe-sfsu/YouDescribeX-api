...
const createParticipants = require('./routes/createParticipants');
...
app.use('/api/create-participant-links', createParticipants);
app.use('/api/add-timedata-to-db', timing);
