    ...
    components: {
      schemas: {
        ...
        IAudioClips: {
          ...
          required: ['clip_id', 'clip_title', 'description_type', 'description_text', 'playback_type', 'clip_start_time', 'clip_end_time', 'clip_duration', 'clip_audio_path', 'is_recorded', 'AudioDescriptionAdId'],
          additionalProperties: false,
        },
        IAudioDescriptions: {
          type: 'object',
