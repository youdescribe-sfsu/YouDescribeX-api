...
class AudioDescriptionsRoute implements Routes {
  ...
  private initializeRoutes() {
    ...
    this.router.post(`${this.path}/publish-audio-description`, trackContributions(), this.audioDescriptionsController.publishAudioDescription);
    this.router.post(`${this.path}/unpublish-audio-description`, trackContributions(), this.audioDescriptionsController.unpublishAudioDescription);
  }
}
