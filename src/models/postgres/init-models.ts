...
export {
  _Audio_Clips as Audio_Clips,
  _Audio_Descriptions as Audio_Descriptions,
  _Dialog_Timestamps as Dialog_Timestamps,
  _Notes as Notes,
...
function initModels(sequelize: Sequelize) {
  ...
  Audio_Clips.belongsTo(Audio_Descriptions, { as: "AudioDescriptionAd", foreignKey: "AudioDescriptionAdId"});
  Audio_Descriptions.hasMany(Audio_Clips, { as: "Audio_Clips", foreignKey: "AudioDescriptionAdId"});
  Notes.belongsTo(Audio_Descriptions, { as: "AudioDescriptionAd", foreignKey: "AudioDescriptionAdId"});
  Audio_Descriptions.hasMany(Notes, { as: "Notes", foreignKey: "AudioDescriptionAdId"});
  Timings.belongsTo(Participants, { as: "ParticipantParticipant", foreignKey: "ParticipantParticipantId"});
  Participants.hasMany(Timings, { as: "Timings", foreignKey: "ParticipantParticipantId"});
  Audio_Descriptions.belongsTo(Users, { as: "UserUser", foreignKey: "UserUserId"});
  Users.hasMany(Audio_Descriptions, { as: "Audio_Descriptions", foreignKey: "UserUserId"});
  Audio_Descriptions.belongsTo(Videos, { as: "VideoVideo", foreignKey: "VideoVideoId"});
  Videos.hasMany(Audio_Descriptions, { as: "Audio_Descriptions", foreignKey: "VideoVideoId"});
  Dialog_Timestamps.belongsTo(Videos, { as: "VideoVideo", foreignKey: "VideoVideoId"});
  Videos.hasMany(Dialog_Timestamps, { as: "Dialog_Timestamps", foreignKey: "VideoVideoId"});
...
export const {
  ...
  PostGres_Notes,
  PostGres_Participants,
  PostGres_Timings,
  PostGres_Users,
  PostGres_Videos,
} = initModels(getPostGresConnection());
